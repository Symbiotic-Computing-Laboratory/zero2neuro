...
# Do the work
# Full training set
#python $ZERO2NEURO_PATH/zero2neuro.py @network_config.txt @data_config.txt @experiment_config.txt -vvv -dd
...
#python $ZERO2NEURO_PATH/zero2neuro.py @network_config.txt @data_config3.txt @experiment_config.txt -vvv -dd

# Assemble full training set from parts with full data set as validation.  
# Ins are in two parts in the pickle files & have to be  connected together
#python $ZERO2NEURO_PATH/zero2neuro.py @network_config.txt @data_config4.txt @experiment_config.txt -vvv -dd

# Both tests at the same time
python $ZERO2NEURO_PATH/zero2neuro.py @network_config.txt @data_config5.txt @experiment_config.txt -vvv -dd
