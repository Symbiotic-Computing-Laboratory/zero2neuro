...
python $ZERO2NEURO_PATH/zero2neuro.py @network.txt @data.txt @experiment.txt -vvv --wandb --wandb_project 'iris training' --force --log_training_set --log_validation_set --log_test_set
