'''
prepare_data_prior_v7.py
---------------
Mosquito dataset preparation for the Zero2Neuro RNN pipeline.

Identical to prepare_data_prior_v2.py, but strictly filtered 
to ONLY include the years 2022, 2023, and 2024.
'''
...
# argument definitions without duplicating them here.
...
def main():
    ...
    # -----------------------------------------------------------------------
    # MODIFICATION: Hardcode years to only include 2022, 2023, 2024
