...
class netcdf_loader(GenericPlugin):
    ...
    def call(self, **kwargs) -> dict:
        '''
        Main execution step. Opens the NetCDF file, maps data, and packages it for the engine.
        '''
        args = require(kwargs, 'args')
        file_path = require(kwargs, 'file_path')
        ...
        print_debug(
            ...
            f"weights={getattr(weights,'shape',None)} groups={getattr(groups,'shape',None)} "
