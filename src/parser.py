...
def create_parser(description='Zero2Neuro'):
    ...
    parser.add_argument('--metrics_weighted', nargs='+', type=str, default=[], help="Metrics to compute (respecting sample weights)")
    ...
    parser.add_argument('--data_format', type=str, default=None, help='Incoming format for the data (tabular, pickle, tf-dataset, plugin)')
    ...
    # Extensible Plugins
    parser.add_argument('--plugin_list', action='extend', nargs='+', type=str, default=[],
                        help='Plugins to load, formatted as a list of strings: "name-role, args". '
                             ...
                             'args is a comma-separated key=value string (optional).')
    ...
    parser.add_argument('--tokenizer_output_sequence_length', type=int, default=None, help='Maximum number of tokens in any given input string')
    ...
    parser.add_argument('--conv_padding', type=str, default='valid', help='Padding type for convolutional layers (valid (default) or same)')
