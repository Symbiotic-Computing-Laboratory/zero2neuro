...
__Step 1.__ Typically defined in a separate configuration file (e.g.,
_cartesian.txt_):
...
__Step 2.__ Declare which combination to execute.  This is typically given at
the command line:
```text
...
__Step 2.__ cartesian_selection_index can then be in the range of 0..14,
...
### By hand at the command line or in a Jupyter cell
...
### Batch file in SLURM (on the OU Supercomputer)
